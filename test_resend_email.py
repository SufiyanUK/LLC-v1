"""
Test script to send email using Resend API to venrocksourcing@gmail.com
"""
...
async def send_test_email():
    """Send a test email to venrocksourcing@gmail.com"""
    ...
    # Check configuration
    if sender.use_resend:
        print(f"[OK] Resend configured")
        print(f"   - From: {sender.resend_from}")
        print(f"   - To: venrocksourcing@gmail.com")
        print(f"   - Using Resend API (no personal email needed)")
    else:
        print(f"[INFO] Resend not available, using SMTP fallback")
        print(f"   - From: {sender.sender_email}")
        print(f"   - To: venrocksourcing@gmail.com")
    
    # Create test departure data
    test_departures = [
        {
            'name': 'John Smith',
    ...
    if success:
        ...
        print("   Please check Resend configuration and API key")
        return False
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 60)
    if success:
        print("TEST COMPLETED - Email sent to venrocksourcing@gmail.com")
    else:
